...
{
    public class GetProizvodiPoPodkategorijiQueryHandler
     : IRequestHandler<GetProizvodiPoPodkategorijiQuery, IEnumerable<ProizvodDto>>
    {
        private readonly IUnitOfWork _unitOfWork;

        public GetProizvodiPoPodkategorijiQueryHandler(IUnitOfWork unitOfWork)
        {
            _unitOfWork = unitOfWork;
        }

        public Task<IEnumerable<ProizvodDto>> Handle(
            GetProizvodiPoPodkategorijiQuery request,
            CancellationToken cancellationToken)
        {
            var proizvodi = _unitOfWork.Proizvodi.GetSviSaPodKategorijom(request.PodkategorijaId);
